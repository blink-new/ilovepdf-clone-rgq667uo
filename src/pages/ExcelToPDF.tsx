...
export default function ExcelToPDF({ user }: ExcelToPDFProps) {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      for (const file of files) {
        const result = await PDFProcessor.documentToPDF(file, 'excel')
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-50">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Excel to PDF Conversion Complete!</h1>
          </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent className="text-center">
              <p className="text-gray-600 mb-6">
                Your Excel spreadsheets have been converted to PDF format. Download the files below.
              </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Make EXCEL spreadsheets easy to read by converting them to PDF.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-semibold mb-2">Preserve Data</h3>
              <p className="text-sm text-gray-600">Maintain all spreadsheet data and formatting</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              <CheckCircle className="h-12 w-12 text-green-500 mx-auto mb-4" />
              <h3 className="font-semibold mb-2">Multiple Sheets</h3>
              <p className="text-sm text-gray-600">Each worksheet becomes a separate PDF page</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600">Perfect for sharing and printing spreadsheets</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <h3 className="font-semibold mb-4">How Excel to PDF Conversion Works</h3>
            <div className="space-y-3 text-sm text-gray-600">
              <div className="flex items-start">
                ...
                <p>Upload your Excel files (XLS or XLSX format)</p>
              </div>
              <div className="flex items-start">
                ...
                <p>Each worksheet is converted to a separate page in the PDF</p>
              </div>
              <div className="flex items-start">
                ...
                <p>Data, formulas (as values), and formatting are preserved</p>
              </div>
              <div className="flex items-start">
                ...
                <p>Download your PDF ready for sharing, printing, or archiving</p>
              </div>
            </div>
          </CardContent>
        </Card>
