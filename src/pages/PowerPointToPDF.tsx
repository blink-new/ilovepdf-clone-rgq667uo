...
export default function PowerPointToPDF({ user }: PowerPointToPDFProps) {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      for (const file of files) {
        const result = await PDFProcessor.documentToPDF(file, 'powerpoint')
        ...
        if (result.success && result.file) {
          ...
          throw new Error(result.error || 'Failed to convert presentation')
        }
      }
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">PowerPoint to PDF Conversion Complete!</h1>
          </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent className="text-center">
              <p className="text-gray-600 mb-6">
                Your PowerPoint presentations have been converted to PDF format. Download the files below.
              </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Make PPT and PPTX slideshows easy to view by converting them to PDF.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-semibold mb-2">Slide to Page</h3>
              <p className="text-sm text-gray-600">Each slide becomes a separate PDF page</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600">Maintain slide layouts, fonts, and graphics</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              <Download className="h-12 w-12 text-orange-500 mx-auto mb-4" />
              <h3 className="font-semibold mb-2">Universal Viewing</h3>
              <p className="text-sm text-gray-600">View presentations on any device without PowerPoint</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="text-center">Upload PowerPoint Files</CardTitle>
          </CardHeader>
          <CardContent>
            <FileUpload
        ...
        <Card>
          <CardContent className="p-6">
            <h3 className="font-semibold mb-4">How PowerPoint to PDF Conversion Works</h3>
            <div className="space-y-3 text-sm text-gray-600">
              <div className="flex items-start">
                ...
                <p>Upload your PowerPoint files (PPT or PPTX format)</p>
              </div>
              <div className="flex items-start">
                ...
                <p>Each slide is converted to a separate page in the PDF</p>
              </div>
              <div className="flex items-start">
                ...
                <p>Slide layouts, text, images, and graphics are preserved</p>
              </div>
              <div className="flex items-start">
                ...
                <p>Download your PDF presentation ready for sharing or printing</p>
              </div>
            </div>
          </CardContent>
        </Card>
